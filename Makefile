...
test: $(BUILD_DIR)/test_reset $(BUILD_DIR)/test_opcodes $(BUILD_DIR)/test_functional_suite $(BUILD_DIR)/test_interrupts $(BUILD_DIR)/test_stack_wraparound $(BUILD_DIR)/test_exec6502 $(BUILD_DIR)/test_disk_sector_layout $(BUILD_DIR)/test_disk_sector_layout_null_safety $(BUILD_DIR)/test_disk_sector_layout_boundary_cases $(BUILD_DIR)/test_disk_sector_layout_max_track_sector $(BUILD_DIR)/test_disk2_controller $(BUILD_DIR)/test_disk2_controller_nibble_roundtrip $(BUILD_DIR)/test_disk2_controller_seek_overshoot_readable $(BUILD_DIR)/test_disk2_controller_head_desync_after_overshoot $(BUILD_DIR)/test_disk2_controller_boot_rom $(BUILD_DIR)/test_disk2_controller_motor_off_freeze $(BUILD_DIR)/test_disk2_controller_motor_spindown_grace_period $(BUILD_DIR)/test_disk_trap $(BUILD_DIR)/test_disk_trap_safe_defaults $(BUILD_DIR)/test_disk_trap_unload_image $(BUILD_DIR)/test_disk_trap_unmounted_image_safety $(BUILD_DIR)/test_disk_trap_has_selection $(BUILD_DIR)/test_disk_trap_get_selected_offset $(BUILD_DIR)/test_disk_trap_get_selected_offset_rejects_invalid $(BUILD_DIR)/test_disk_trap_clear_image $(BUILD_DIR)/test_disk_trap_get_image_ptr $(BUILD_DIR)/test_apple2_mem_reset_clears_disk_trap_selection $(BUILD_DIR)/test_video_apple2 $(BUILD_DIR)/test_video_apple2_safety $(BUILD_DIR)/test_video_apple2_row_offsets_bounds $(BUILD_DIR)/test_video_apple2_color $(BUILD_DIR)/test_video_apple2_color_edges $(BUILD_DIR)/test_video_apple2_fullframe $(BUILD_DIR)/test_video_apple2_realbus $(BUILD_DIR)/test_video_apple2_page2 $(BUILD_DIR)/test_video_apple2_color_page2 $(BUILD_DIR)/test_lores_apple2 $(BUILD_DIR)/test_lores_apple2_palette $(BUILD_DIR)/test_lores_apple2_safety $(BUILD_DIR)/test_lores_apple2_color_bounds $(BUILD_DIR)/test_lores_apple2_row_offsets_bounds $(BUILD_DIR)/test_text_apple2 $(BUILD_DIR)/test_uart_keyboard_bridge $(BUILD_DIR)/test_woz_disk $(BUILD_DIR)/test_emu_trace $(BUILD_DIR)/test_bunnie_audio $(BUILD_DIR)/test_bunnie_audio_null_safety $(BUILD_DIR)/test_bunnie_audio_toggle_toggle_no_lost_edges $(BUILD_DIR)/test_apple2_mem $(BUILD_DIR)/test_apple2_mem_button_getter $(BUILD_DIR)/test_apple2_mem_button_bounds_safety $(BUILD_DIR)/test_apple2_mem_clear_buttons $(BUILD_DIR)/test_apple2_mem_clear_annunciators $(BUILD_DIR)/test_apple2_mem_reset_uses_clear_helpers $(BUILD_DIR)/test_apple2_mem_reset_clears_paddle_state $(BUILD_DIR)/test_apple2_mem_load_system_rom $(BUILD_DIR)/test_dos33boot_cout_stub $(BUILD_DIR)/test_apple2_mem_disk_controller_mode $(BUILD_DIR)/test_apple2_mem_disk2_boot_rom $(BUILD_DIR)/test_bio_display $(BUILD_DIR)/test_text_apple2 $(BUILD_DIR)/test_bio_display_page2 $(BUILD_DIR)/test_bio_display_mixed $(BUILD_DIR)/test_bio_display_auto $(BUILD_DIR)/test_bio_display_lores_mixed $(BUILD_DIR)/test_bio_display_lores_crt_mode $(BUILD_DIR)/test_bio_display_safety $(BUILD_DIR)/test_bio_display_text_mode $(BUILD_DIR)/test_fb_terminal_viewer $(BUILD_DIR)/test_rram_driver $(BUILD_DIR)/test_rram_driver_read_bounds $(BUILD_DIR)/test_rram_driver_docstring_accuracy $(BUILD_DIR)/test_rram_driver_page_aligned_boundary_write $(BUILD_DIR)/test_rram_driver_erase_bounds_safety $(BUILD_DIR)/test_rram_cartridge_write_bounds $(BUILD_DIR)/test_cartridge_layout $(BUILD_DIR)/test_cartridge_layout_bounds_safety $(BUILD_DIR)/test_cartridge_layout_get_slot_null_safety $(BUILD_DIR)/test_cartridge_layout_find_by_title $(BUILD_DIR)/test_rram_cartridge_integration $(BUILD_DIR)/test_rram_disk_trap_pipeline $(BUILD_DIR)/test_boot_splash $(BUILD_DIR)/test_boot_splash_apple2_mem_poll $(BUILD_DIR)/test_boot_splash_multibutton_tiebreak $(BUILD_DIR)/test_boot_splash_null_safety $(BUILD_DIR)/test_boot_splash_invalid_index_clamping $(BUILD_DIR)/test_boot_splash_select_slot_by_index $(BUILD_DIR)/test_boot_splash_get_selected_slot_index $(BUILD_DIR)/test_emulator_loop $(BUILD_DIR)/test_emulator_loop_get_framebuffer_nonnull $(BUILD_DIR)/test_emulator_loop_is_audio_active $(BUILD_DIR)/test_emulator_loop_reset_combo $(BUILD_DIR)/test_emulator_loop_reset_combo_no_spurious_nav $(BUILD_DIR)/test_emulator_loop_reset_combo_partial_release $(BUILD_DIR)/test_emulator_loop_video_mode $(BUILD_DIR)/test_emulator_loop_copy_framebuffer $(BUILD_DIR)/test_emulator_loop_copy_framebuffer_null_safety $(BUILD_DIR)/test_emulator_loop_framebuffer_bounds $(BUILD_DIR)/test_emulator_loop_current_slot $(BUILD_DIR)/test_emulator_loop_select_attaches_disk_image $(BUILD_DIR)/test_emulator_loop_select_slot1_attaches_disk_image $(BUILD_DIR)/test_emulator_loop_game_switch_updates_disk_image $(BUILD_DIR)/test_emulator_loop_reselect_same_slot_disk_image $(BUILD_DIR)/test_emulator_loop_select_slot_by_index $(BUILD_DIR)/test_emulator_loop_game_running_execution_cycles $(BUILD_DIR)/test_emulator_loop_splash_active $(BUILD_DIR)/test_emulator_loop_splash_active_matches_canonical $(BUILD_DIR)/test_emulator_loop_reset $(BUILD_DIR)/test_emulator_loop_game_running $(BUILD_DIR)/test_emulator_loop_reset_to_splash $(BUILD_DIR)/test_emulator_loop_reset_to_splash_cycles $(BUILD_DIR)/test_emulator_loop_init_reset_parity $(BUILD_DIR)/test_emulator_loop_no_stale_framebuffer $(BUILD_DIR)/test_emulator_loop_no_stale_framebuffer_combo_reset $(BUILD_DIR)/test_emulator_loop_total_cycles $(BUILD_DIR)/test_emulator_loop_audio_active $(BUILD_DIR)/test_emulator_loop_cycles_per_frame $(BUILD_DIR)/test_emulator_loop_dma_push $(BUILD_DIR)/test_boot_perf $(BUILD_DIR)/test_boot_perf_safety $(BUILD_DIR)/test_boot_perf_null_metrics $(BUILD_DIR)/test_boot_perf_cycles_to_us $(BUILD_DIR)/test_ramfb_display $(BUILD_DIR)/test_main_boot_perf $(BUILD_DIR)/test_main_boot_metrics_getter $(BUILD_DIR)/test_dos33_composed_boot
	...
	@$(BUILD_DIR)/test_disk_sector_layout_max_track_sector
	@$(BUILD_DIR)/test_disk2_controller
	@$(BUILD_DIR)/test_disk2_controller_nibble_roundtrip
	@$(BUILD_DIR)/test_disk2_controller_seek_overshoot_readable
	@$(BUILD_DIR)/test_disk2_controller_head_desync_after_overshoot
	@$(BUILD_DIR)/test_disk2_controller_boot_rom
	@$(BUILD_DIR)/test_disk2_controller_motor_off_freeze
	@$(BUILD_DIR)/test_disk2_controller_motor_spindown_grace_period
	...
	@$(BUILD_DIR)/test_disk_trap_get_selected_offset_rejects_invalid
	...
	@$(BUILD_DIR)/test_video_apple2_row_offsets_bounds
	...
	@$(BUILD_DIR)/test_lores_apple2_row_offsets_bounds
	@$(BUILD_DIR)/test_text_apple2
	@$(BUILD_DIR)/test_uart_keyboard_bridge
	@$(BUILD_DIR)/test_woz_disk
	@$(BUILD_DIR)/test_emu_trace
	...
	@$(BUILD_DIR)/test_apple2_mem_load_system_rom
	@$(BUILD_DIR)/test_dos33boot_cout_stub
	@$(BUILD_DIR)/test_apple2_mem_disk_controller_mode
	@$(BUILD_DIR)/test_apple2_mem_disk2_boot_rom
	...
	@$(BUILD_DIR)/test_bio_display_lores_crt_mode
	...
	@$(BUILD_DIR)/test_boot_splash_select_slot_by_index
	@$(BUILD_DIR)/test_boot_splash_get_selected_slot_index
	...
	@$(BUILD_DIR)/test_emulator_loop_select_slot_by_index
	...
	@$(BUILD_DIR)/test_boot_perf_null_metrics
	@$(BUILD_DIR)/test_boot_perf_cycles_to_us
	@$(BUILD_DIR)/test_ramfb_display
	...
	@python3 -m unittest tests.test_dsk_to_nib -v
...
$(BUILD_DIR)/test_disk_sector_layout_max_track_sector: $(TEST_DIR)/test_disk_sector_layout_max_track_sector.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_sector_layout.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk_sector_layout_max_track_sector.c $(SRC_DIR)/disk_sector_layout.c

$(BUILD_DIR)/test_disk2_controller: $(TEST_DIR)/test_disk2_controller.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h
	@mkdir -p $(BUILD_DIR)
...
$(BUILD_DIR)/test_disk2_controller_seek_overshoot_readable: $(TEST_DIR)/test_disk2_controller_seek_overshoot_readable.c $(TEST_DIR)/test_disk2_controller_nibble_roundtrip_encoder.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk2_controller_seek_overshoot_readable.c $(TEST_DIR)/test_disk2_controller_nibble_roundtrip_encoder.c $(SRC_DIR)/disk2_controller.c

$(BUILD_DIR)/test_disk2_controller_head_desync_after_overshoot: $(TEST_DIR)/test_disk2_controller_head_desync_after_overshoot.c $(TEST_DIR)/test_disk2_controller_nibble_roundtrip_encoder.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk2_controller_head_desync_after_overshoot.c $(TEST_DIR)/test_disk2_controller_nibble_roundtrip_encoder.c $(SRC_DIR)/disk2_controller.c

$(BUILD_DIR)/test_disk2_controller_boot_rom: $(TEST_DIR)/test_disk2_controller_boot_rom.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk2_controller_boot_rom.c $(SRC_DIR)/disk2_controller.c

$(BUILD_DIR)/test_disk2_controller_motor_off_freeze: $(TEST_DIR)/test_disk2_controller_motor_off_freeze.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk2_controller_motor_off_freeze.c $(SRC_DIR)/disk2_controller.c

$(BUILD_DIR)/test_disk2_controller_motor_spindown_grace_period: $(TEST_DIR)/test_disk2_controller_motor_spindown_grace_period.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk2_controller_motor_spindown_grace_period.c $(SRC_DIR)/disk2_controller.c
...
$(BUILD_DIR)/test_disk_trap_get_selected_offset_rejects_invalid: $(TEST_DIR)/test_disk_trap_get_selected_offset_rejects_invalid.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_sector_layout.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_disk_trap_get_selected_offset_rejects_invalid.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c
...
$(BUILD_DIR)/test_apple2_mem_reset_clears_disk_trap_selection: $(TEST_DIR)/test_apple2_mem_reset_clears_disk_trap_selection.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_reset_clears_disk_trap_selection.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
...
$(BUILD_DIR)/test_video_apple2_row_offsets_bounds: $(TEST_DIR)/test_video_apple2_row_offsets_bounds.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_video_apple2_row_offsets_bounds.c $(SRC_DIR)/video_apple2.c
...
$(BUILD_DIR)/test_video_apple2_realbus: $(TEST_DIR)/test_video_apple2_realbus.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_video_apple2_realbus.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_video_apple2_page2: $(TEST_DIR)/test_video_apple2_page2.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_video_apple2_page2.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_video_apple2_color_page2: $(TEST_DIR)/test_video_apple2_color_page2.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_video_apple2_color_page2.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
...
$(BUILD_DIR)/test_lores_apple2_row_offsets_bounds: $(TEST_DIR)/test_lores_apple2_row_offsets_bounds.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/lores_apple2.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_lores_apple2_row_offsets_bounds.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/video_apple2.c

$(BUILD_DIR)/test_text_apple2: $(TEST_DIR)/test_text_apple2.c $(SRC_DIR)/text_apple2.c $(SRC_DIR)/text_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/lores_apple2.h $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/charrom_342_0133_a.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_text_apple2.c $(SRC_DIR)/text_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c

$(BUILD_DIR)/test_uart_keyboard_bridge: $(TEST_DIR)/test_uart_keyboard_bridge.c $(SRC_DIR)/uart_keyboard_bridge.c $(SRC_DIR)/uart_keyboard_bridge.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_uart_keyboard_bridge.c $(SRC_DIR)/uart_keyboard_bridge.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_woz_disk: $(TEST_DIR)/test_woz_disk.c $(SRC_DIR)/woz_disk.c $(SRC_DIR)/woz_disk.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_woz_disk.c $(SRC_DIR)/woz_disk.c

$(BUILD_DIR)/test_emu_trace: $(TEST_DIR)/test_emu_trace.c $(SRC_DIR)/emu_trace.c $(SRC_DIR)/emu_trace.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_emu_trace.c $(SRC_DIR)/emu_trace.c
...
$(BUILD_DIR)/test_apple2_mem: $(TEST_DIR)/test_apple2_mem.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_button_getter: $(TEST_DIR)/test_apple2_mem_button_getter.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_button_getter.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_button_bounds_safety: $(TEST_DIR)/test_apple2_mem_button_bounds_safety.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_button_bounds_safety.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_clear_buttons: $(TEST_DIR)/test_apple2_mem_clear_buttons.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_clear_buttons.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_clear_annunciators: $(TEST_DIR)/test_apple2_mem_clear_annunciators.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_clear_annunciators.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_reset_uses_clear_helpers: $(TEST_DIR)/test_apple2_mem_reset_uses_clear_helpers.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_reset_uses_clear_helpers.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_reset_clears_paddle_state: $(TEST_DIR)/test_apple2_mem_reset_clears_paddle_state.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_reset_clears_paddle_state.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_load_system_rom: $(TEST_DIR)/test_apple2_mem_load_system_rom.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_load_system_rom.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_dos33boot_cout_stub: $(TEST_DIR)/test_dos33boot_cout_stub.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_dos33boot_cout_stub.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_disk_controller_mode: $(TEST_DIR)/test_apple2_mem_disk_controller_mode.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_disk_controller_mode.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_apple2_mem_disk2_boot_rom: $(TEST_DIR)/test_apple2_mem_disk2_boot_rom.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_apple2_mem_disk2_boot_rom.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_bio_display: $(TEST_DIR)/test_bio_display.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_page2: $(TEST_DIR)/test_bio_display_page2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_page2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_mixed: $(TEST_DIR)/test_bio_display_mixed.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_mixed.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_auto: $(TEST_DIR)/test_bio_display_auto.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/lores_apple2.h $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_auto.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_lores_mixed: $(TEST_DIR)/test_bio_display_lores_mixed.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/lores_apple2.h $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_lores_mixed.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_lores_crt_mode: $(TEST_DIR)/test_bio_display_lores_crt_mode.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/video_apple2.h $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/lores_apple2.h $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_lores_crt_mode.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_safety: $(TEST_DIR)/test_bio_display_safety.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_safety.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_bio_display_text_mode: $(TEST_DIR)/test_bio_display_text_mode.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_bio_display_text_mode.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/test_fb_terminal_viewer: $(TEST_DIR)/test_fb_terminal_viewer.c $(TOOLS_DIR)/fb_terminal_viewer.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_fb_terminal_viewer.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/fb_terminal_viewer: $(TOOLS_DIR)/fb_terminal_viewer.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/bio_display.h $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TOOLS_DIR)/fb_terminal_viewer.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c

$(BUILD_DIR)/dump_framebuffer: $(TOOLS_DIR)/dump_framebuffer.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/emulator_loop.h $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TOOLS_DIR)/dump_framebuffer.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c $(SRC_DIR)/text_apple2.c
...
$(BUILD_DIR)/test_dos33_composed_boot: $(TEST_DIR)/test_dos33_composed_boot.c src/embedded_disk_dos33.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_dos33_composed_boot.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c
...
$(BUILD_DIR)/test_cartridge_layout_find_by_title: $(TEST_DIR)/test_cartridge_layout_find_by_title.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_cartridge_layout_find_by_title.c $(SRC_DIR)/cartridge_layout.c
...
$(BUILD_DIR)/test_boot_splash: $(TEST_DIR)/test_boot_splash.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_boot_splash_apple2_mem_poll: $(TEST_DIR)/test_boot_splash_apple2_mem_poll.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash_apple2_mem_poll.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
...
$(BUILD_DIR)/test_boot_splash_multibutton_tiebreak: $(TEST_DIR)/test_boot_splash_multibutton_tiebreak.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash_multibutton_tiebreak.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
...
$(BUILD_DIR)/test_boot_splash_null_safety: $(TEST_DIR)/test_boot_splash_null_safety.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash_null_safety.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
...
$(BUILD_DIR)/test_boot_splash_invalid_index_clamping: $(TEST_DIR)/test_boot_splash_invalid_index_clamping.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash_invalid_index_clamping.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_boot_splash_select_slot_by_index: $(TEST_DIR)/test_boot_splash_select_slot_by_index.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash_select_slot_by_index.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_boot_splash_get_selected_slot_index: $(TEST_DIR)/test_boot_splash_get_selected_slot_index.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/boot_splash.h $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/cartridge_layout.h $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/disk_trap.h $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_splash_get_selected_slot_index.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c

$(BUILD_DIR)/test_emulator_loop: $(TEST_DIR)/test_emulator_loop.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/emulator_loop.h $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_emulator_loop.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
...
$(BUILD_DIR)/test_emulator_loop_reset: $(TEST_DIR)/test_emulator_loop_reset.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/emulator_loop.h $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_emulator_loop_reset.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
...
$(BUILD_DIR)/test_emulator_loop_select_slot_by_index: $(TEST_DIR)/test_emulator_loop_select_slot_by_index.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/emulator_loop.h $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_emulator_loop_select_slot_by_index.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c $(SRC_DIR)/text_apple2.c
...
$(BUILD_DIR)/test_boot_perf_null_metrics: $(TEST_DIR)/test_boot_perf_null_metrics.c $(SRC_DIR)/boot_perf.c $(SRC_DIR)/boot_perf.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_perf_null_metrics.c $(SRC_DIR)/boot_perf.c

$(BUILD_DIR)/test_boot_perf_cycles_to_us: $(TEST_DIR)/test_boot_perf_cycles_to_us.c $(SRC_DIR)/boot_perf.c $(SRC_DIR)/boot_perf.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_boot_perf_cycles_to_us.c $(SRC_DIR)/boot_perf.c

$(BUILD_DIR)/test_ramfb_display: $(TEST_DIR)/test_ramfb_display.c $(SRC_DIR)/ramfb_display.c $(SRC_DIR)/ramfb_display.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(TEST_DIR)/test_ramfb_display.c $(SRC_DIR)/ramfb_display.c
