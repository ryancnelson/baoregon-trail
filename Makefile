...
$(BUILD_DIR)/dump_framebuffer: $(TOOLS_DIR)/dump_framebuffer.c $(SRC_DIR)/emulator_loop.c $(SRC_DIR)/emulator_loop.h $(SRC_DIR)/boot_splash.c $(SRC_DIR)/cartridge_layout.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c
	@mkdir -p $(BUILD_DIR)
...
$(BUILD_DIR)/hires_demo_runner: $(TOOLS_DIR)/hires_demo_runner.c $(TOOLS_DIR)/fb_terminal_viewer.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/apple2_mem.h $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/disk2_controller.h $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -DFB_TERMINAL_VIEWER_NO_MAIN -o $@ $(TOOLS_DIR)/hires_demo_runner.c $(TOOLS_DIR)/fb_terminal_viewer.c $(SRC_DIR)/apple2_mem.c $(SRC_DIR)/disk2_controller.c $(SRC_DIR)/cpu6502.c $(SRC_DIR)/disk_sector_layout.c $(SRC_DIR)/disk_trap.c $(SRC_DIR)/bunnie_audio.c $(SRC_DIR)/video_apple2.c $(SRC_DIR)/bio_display.c $(SRC_DIR)/lores_apple2.c
